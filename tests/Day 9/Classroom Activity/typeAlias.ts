...
type userInfo = string | number // userInfo becomes a user defined data type that can only store String and Number at the same time

let fname : userInfo = "Naveen"
let phoneNumber : userInfo = 9843553470
let emailID : userInfo = "nkwilmanage@gmail.com"
...
type supportedChannels = "Sun TV" | "Vijay TV" | "Cartoon Network"

function onChannel(channelName : supportedChannels){
...
function makePayment (methodName : paymentMethod){
    console.log("The Payment method chosen is", methodName)
}
makePayment("UPI")
