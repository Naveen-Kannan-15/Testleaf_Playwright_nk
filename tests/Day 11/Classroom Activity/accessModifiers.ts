...
export class EmployeeSignUp {
    ...
    private empSalary : string // private keyword makes the empSalary not to be accessed outside the class
    protected empPhone : number // protected keyword is also similar to the private keyword
